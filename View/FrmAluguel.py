...
class Ui_FrmAluguel(object):
    ...
    def btnSalvar_Click(self):
        ...
        print("Aluguel registado com sucesso!")
        msg = QMessageBox()
        msg.setWindowIcon(QIcon("Imagens/btnAlugaVeiculo.png"))
    ...
    def setupUi(self, FrmAluguel):
        ...
        self.EdtDataAluguel.setPlaceholderText("dd/mm/aaaa")
        ...
        self.EdtPrazo.setPlaceholderText("dd/mm/aaaa")
        ...
        self.EdtDataDev.setPlaceholderText("dd/mm/aaaa")
        ...
        self.EdtValor.setPlaceholderText("R$ 0,00")       
        ...
        self.EdtkmEntrada.setPlaceholderText("0000")
        ...
        self.EdtKmSaida.setPlaceholderText("0000")
        ...
        self.btnPesqCliente.setIconSize(QtCore.QSize(20, 20))
        self.btnPesqCliente.setObjectName(_fromUtf8("btnPesqCliente"))
        # botão pesquisar cliente CLICK.
        ...
        self.btnPesqVeic.setIconSize(QtCore.QSize(20, 20))
        self.btnPesqVeic.setObjectName(_fromUtf8("btnPesqVeic"))
        # botão pesquisar veículo CLICK.
    ...
    def retranslateUi(self, FrmAluguel):
        ...
        self.label_3.setText(_translate("FrmAluguel", "Valor do Aluguel:", None))
        self.label_4.setText(_translate("FrmAluguel", "KM Entrada:", None))
        self.label_5.setText(_translate("FrmAluguel", "Valor da Multa:", None))
        self.label_6.setText(_translate("FrmAluguel", "KM Entrada:", None))
        self.label_7.setText(_translate("FrmAluguel", "KM Saída:", None))
        ...
        item.setText(_translate("FrmAluguel", "Condição", None))
        ...
        item.setText(_translate("FrmAluguel", "Valor da Diária", None))
