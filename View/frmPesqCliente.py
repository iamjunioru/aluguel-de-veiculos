...
class Ui_frmPesqCliente(object):
    ...
    def atualizar_lista(self, text):
        # estrutura p ler se to digitando número ou letra
        if text.isdigit():
            self.PesquisarCliente(text, 'CPF')
        else:
            self.PesquisarCliente(text, 'Nome')

                      
    def setupUi(self, frmPesqCliente):
        frmPesqCliente.setObjectName(_fromUtf8("frmPesqCliente"))

        # desabilitar redimensionamento de janela.
        frmPesqCliente.setFixedSize(651, 504)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("Imagens/btnListClientes.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        # edit pesquisar #  
        # search bar #
        self.pesquisartudo = QtGui.QLabel(frmPesqCliente)
        self.pesquisartudo.setGeometry(QtCore.QRect(50, 90, 300, 20))
        self.pesquisartudo.setObjectName(_fromUtf8("lblTotal"))
        self.edtPesquisa = QtGui.QLineEdit(frmPesqCliente)
        self.edtPesquisa.setGeometry(QtCore.QRect(190, 90, 330, 20))
    ...
    def retranslateUi(self, frmPesqCliente):
        ...
        self.lblTotal.setText(_translate("frmPesqCliente", "Pesquisar/Atualizar", None))
        self.btnExcluir.setText(_translate("frmPesqCliente", "Excluir", None))
        self.btnAlterar.setText(_translate("frmPesqCliente", "Editar", None))
        self.pesquisartudo.setText(_translate("frmPesqCliente", "Pesquisar Nome ou CPF:", None))
