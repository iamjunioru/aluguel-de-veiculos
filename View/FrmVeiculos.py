...
class Ui_frmVeiculos(object):
    # preencher os campos p alteração.
    ...
    def btnSalvar_Click(self, estado, codigoVeic):
        ...
        # close veiculos janela
        self.frmVeiculos.close()
        print("Tela de Veículos fechada.")

        # verifica inserir/alterar p função apropiada.
        if estado=='inserir':
            veiculo = VeiculoCTR
            ...
            msg = QMessageBox()
            msg.setWindowIcon(QIcon("Imagens/confirm.png"))
            msg.setIcon(QMessageBox.Information)
            msg.setText("Veículo cadastrado com sucesso!")
            msg.setWindowTitle("Veículo Cadastrado")
        ...
        if estado=='alterar':
            ...
            msg = QMessageBox()
            pixmap = QPixmap("Imagens/edit.png").scaled(70, 70)
            msg.setWindowIcon(QIcon("Imagens/edit.png"))
            msg.setIconPixmap(pixmap)
            msg.setIcon(QMessageBox.Information)
            msg.setText("Veículo editado com sucesso!")
            #msg.setInformativeText("")
            msg.setWindowTitle("Veículo editado")
            #msg.setDetailedText("")
            msg.setStandardButtons(QMessageBox.Ok)
            msg.exec_()
    ...
    def setupUi(self, frmVeiculos, estado, codigoVeic):
        self.frmVeiculos = frmVeiculos
        frmVeiculos.setObjectName(_fromUtf8("frmVeiculos"))

        # desabilita redimensionamento de tela
        ...
        self.edtModelo.setPlaceholderText(_fromUtf8("Modelo"))
        ...
        self.edtMarca.setPlaceholderText(("Marca"))
        ...
        self.edtDiaria.setPlaceholderText(("Diária"))
        ...
        self.edtTipo.setPlaceholderText(("Tipo"))
        ...
        self.edtPlaca.setPlaceholderText(("Placa"))
        ...
        self.label_5.setGeometry(QtCore.QRect(200, 120, 56, 23))
    ...
    def retranslateUi(self, frmVeiculos):
        ...
        self.groupBox_4.setTitle(_translate("frmVeiculos", "Condição:", None))
        self.rbBatido.setText(_translate("frmVeiculos", "Boa", None))
        self.rbPerfeito.setText(_translate("frmVeiculos", "Ruim", None))
