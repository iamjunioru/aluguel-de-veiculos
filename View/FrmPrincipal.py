...
from PyQt4.QtGui import QGraphicsOpacityEffect # fade in lib
...
class Ui_FrmPrincipal(object):
    ...
    def FrmVeiculo_Click(self):
        ...
        print("Abrindo CAD. Veículo...")

    # botão LISTAR TODOS CLIENTES CLICK #
    ...
    # botão LISTAR TODOS VEICULOS CLICK #
    def btnListarVeiculo_Click(self):
        ...
        print("Abrindo Veículos...")

    # botão LISTAR TODOS ALUGUEIS CLICK #
    ...
    def retranslateUi(self, FrmPrincipal):
        FrmPrincipal.setWindowTitle(_translate("FrmPrincipal", "Aluguel de Veículos 1.1.2", None))
        self.btnAlugar.setText(_translate("FrmPrincipal", "Alugar", None))
        self.btnCliente.setText(_translate("FrmPrincipal", "CAD. Cliente", None))
        self.btnVeiculo.setText(_translate("FrmPrincipal", "CAD. Veículo", None))
        self.btnListCliente.setText(_translate("FrmPrincipal", "Clientes", None))
        self.btnListVeiculo.setText(_translate("FrmPrincipal", "Veículos", None))
        self.btnListAluguel.setText(_translate("FrmPrincipal", "Alugueis", None))
        self.actionCliente.setText(_translate("FrmPrincipal", "Clientes", None))
        self.actionVe_culo.setText(_translate("FrmPrincipal", "Veículos", None))
        self.actionAlugar.setText(_translate("FrmPrincipal", "Alugar Veículo", None))
        self.actionCliente_2.setText(_translate("FrmPrincipal", "Cliente", None))
        self.actionVe_culos.setText(_translate("FrmPrincipal", "Veículo", None))
        self.actionAlugueis.setText(_translate("FrmPrincipal", "Aluguel", None))
        self.actionSair.setText(_translate("FrmPrincipal", "Sair", None))
        
        # botões personalizados #
        self.btnAlugar.setStyleSheet('''
            QMainWindow {
        ...
        self.btnListCliente.setStyleSheet('''
            QMainWindow {
                background-color: white;
                border-radius: 10px;
            }
        ...
        self.btnListVeiculo.setStyleSheet('''
            QMainWindow {
                background-color: white;
                border-radius: 10px;
            }
        ...
        self.btnListAluguel.setStyleSheet('''
            QMainWindow {
                background-color: white;
                border-radius: 10px;
            }
