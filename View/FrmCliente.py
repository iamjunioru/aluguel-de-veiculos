...
class Ui_frmCliente(object):
    ...
    def btnSalvar_Click(self, estado, codigoCli):
        ...
        # verifica inserir/salvar p enviar a função apropriada.
        if estado=='inserir':
            cliente = ClienteCTR
            ...
            msg = QMessageBox()
            msg.setWindowIcon(QIcon("Imagens/btnCadCli.png"))
        ...
        if estado=='alterar':
            ...
            msg.setWindowTitle("Editar Cliente")
            msg.setStandardButtons(QMessageBox.Ok)
            msg.exec_()
        ...
        # close
        self.frmCliente.close()
        print("Fechando o formulário de cadastro de cliente...")
        
    def setupUi(self, frmCliente, estado, codigoCli):
        self.frmCliente = frmCliente  # add this line
        ...
        self.edtNome.setPlaceholderText("Nome do Cliente")
        ...
        self.edtCPF.setPlaceholderText("XXX.XXX.XXX-XX")
        ...
        self.edtEmail.setPlaceholderText("seuemail@email.com")
        ...
        self.edtTelefone.setPlaceholderText("(XX) XXXX-XXXX")
        ...
        self.edtEndereco.setPlaceholderText("Rua, Nº, Bairro, Cidade, Estado")
    ...
    def retranslateUi(self, frmCliente):
        ...
        self.lbEmail.setText(_translate("frmCliente", "E-mail:", None))
