...
# contém métodos para cadastrar, atualizar, excluir, pesquisar todos os clientes e pesquisar um cliente específico. 
# os dados dos clientes são armazenados em uma tabela de "Cliente".
class ClienteDAO:
